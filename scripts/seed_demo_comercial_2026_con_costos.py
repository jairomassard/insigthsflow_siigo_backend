...
cuentas = {
    ...
    "613595": {
        "nombre": "Costos directos de prestación de servicios tecnológicos",
        "clase": "6",
        "grupo": "Costos de prestación de servicios",
        "seccion": "Estado de resultados",
        "grupo_balance": "Costos de venta",
        "naturaleza": "debito",
    },
}
...
def insertar_contabilidad(cur, facturas, compras, resumen_nomina):
    ...
    for mes in range(1, 6):
        ...
        # Clasificación contable realista:
        # Una empresa de servicios/software normalmente no debería mostrar utilidad bruta
        # igual a ingresos. Por eso se separa una parte de las compras como costo directo
        # de prestación del servicio (clase 6) y el resto como gastos operacionales/no operacionales.
        #
        # Objetivo demo:
        # - Costos de venta cercanos al 24% de los ingresos netos del mes.
        # - Margen bruto cercano al 76%.
        # - EBITDA positivo, pero con gastos operacionales visibles para análisis gerencial.
        ...
        if costo_directo_mes > 0:
            insertar_auxiliar(
                ...
                fecha_mes,
                "CP",
                f"CP-DEMO-MES-{mes:02d}",
                "613595",
                None,
                "Proveedores demo",
                "Costos directos de prestación de servicios tecnológicos",
                debito=costo_directo_mes,
                base=costo_directo_mes,
            )
        ...
        # Incluye costos clase 6, gastos operacionales clase 5 y gastos no operacionales.
