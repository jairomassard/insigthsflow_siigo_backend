...
def create_app():
    ...
    @app.route("/clientes/<int:idcliente>/paquete", methods=["PUT"])
    @jwt_required()
    def cambiar_paquete_cliente(idcliente):
        ...
        Política:
        - Solo SuperAdmin.
        - Desactiva paquetes base anteriores.
        - Activa o crea el nuevo ClientePaquete.
        - Mantiene módulos adicionales intactos.
        - Clona permisos faltantes desde cliente 1.
        - Asigna permisos del nuevo paquete al perfil Administrador.
        - No borra permisos antiguos; el before_request bloquea por paquete contratado.
        """
        ...
        try:
            ...
            # Desactivar paquetes base activos anteriores.
            ...
            # Activar o crear relación con paquete nuevo.
            rel_nuevo = (
